        ...
        <div class="splitPage_content">
            ...
            <nav class="mainNav mainNav--minTransparent">
                <div class="mainNav_gutter">
                    ...
                    <span>
                        <?php echo $this->lang->line('have_acc'); ?>
                    </span>
            ...
            <div class="container">
                <div class="formSign">
                    ...
                    <div class="socialSign">
                        <p class="text-center"><span><?php echo $this->lang->line('signup'); ?></span><?php echo $this->lang->line('top_t'); ?></p>
                    </div>
                    ...
                    <div class="sign_up_form" id="main_infodiv">
                        ...
                        <div class="form-group">
                            <label for="id_email"><?php echo $this->lang->line('email'); ?></label>
                            <input type="text" id="id_email" placeholder="<?php echo $this->lang->line('email'); ?>" class="form-control" maxlength="75">
                        </div>

                        <div class="form-group">
                            <label for="id_phone"><?php echo $this->lang->line('phone'); ?></label>
                            <input type="number" id="id_phone" placeholder="<?php echo $this->lang->line('phone'); ?>" class="form-control" maxlength="75">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="City" placeholder="City" class="form-control" maxlength="75">
                        </div>
                        <div class="form-group">
                            <label for="Street"><?php echo $this->lang->line('street'); ?></label>
                            <input type="text" id="Street" placeholder="Street" class="form-control" maxlength="75">
                        </div>
                        <div class="form-group">
                            <label for="House_number"><?php echo $this->lang->line('hnum'); ?></label>
                            <input type="number" id="House_number" placeholder="House_number" class="form-control" maxlength="75">
                        </div>
                        <div class="form-group">
                            <label for="Postal_Code"><?php echo $this->lang->line('pcode'); ?></label>
                            <input type="number" id="Postal_Code" placeholder="Postal_Code" class="form-control" maxlength="75">
                        </div>
                        <div class="form-group">
                            <label for="id_password1"><?php echo $this->lang->line('pw'); ?></label>
                            <input type="password" placeholder="<?php echo $this->lang->line('pw'); ?>" class="form-control" id="id_password1">
                    ...
                    <div class="row" id="fileupdiv" style="display:none">
                        <div class="col-lg-12 mtp">
                            <div class="mt-3">
                                <label for="driving"><b><?php echo $this->lang->line('driving'); ?></b></label>
                                <input type="file" id="driving_up" data-plugins="dropify" data-max-file-size="10M" />&nbsp;
                                <input type="text" id="driving" placeholder="<?php echo $this->lang->line('ffn1'); ?>" class="form-control" maxlength="75">
                            </div>
                        </div>

                        <div class="col-lg-12 mtop" >
                            <div class="mt-3">
                                <label for="identity"><b><?php echo $this->lang->line('identity'); ?></b></label>
                                <input type="file" id="idt_up" data-plugins="dropify" data-max-file-size="10M" />&nbsp;
                                <input type="text" id="identity" placeholder="<?php echo $this->lang->line('ffn2'); ?>" class="form-control" maxlength="75">
                            </div>
                        </div>
                    </div>
                    <br><hr>
                        
                    <button class="btn btn-info btn-block" id="rgbt1" onclick="register()"><?php echo $this->lang->line('next'); ?></button>
