 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'sb-mmhj473198625_api1.business.example.com' : 'pagamentos_api1.bananacampers.pt';
$config['APIPassword'] = $config['Sandbox'] ? 'XNVSSGHJND9DTUSM' : 'AMTLYAVCN5ECX7JC';
$config['APISignature'] = $config['Sandbox'] ? 'AZEafLx5VJPD36bVBzRmMxBLOPexAieB37nt3dFvNcOSRXhD23HFA2vf' : 'AJnKBEkGIsirux17W51sOH0uV1LSAV5kZwYRM-cV3wAJdYJrIrWBEJ0j';
...
$config['PayFlowVendor'] = $config['Sandbox'] ? 'Bananacampers' : '';
 ...
 */
$config['DeveloperEmailAccount'] = 'pagamentos@bananacampers.pt';
